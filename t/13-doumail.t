...
SKIP: {
    ...
    is($mail->get_mail_inbox->is_success,  1, "get inbox mail ok");
    is($mail->get_mail_outbox->is_success, 1, "get mail outbox");
    is($mail->get_mail(doumailID => '55556547')->is_success, 1,
        "get doumail");
